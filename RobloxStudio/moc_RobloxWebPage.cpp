...
struct qt_meta_stringdata_RobloxWebPage_t {
    QByteArrayData data[4];
    char stringdata0[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RobloxWebPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RobloxWebPage_t qt_meta_stringdata_RobloxWebPage = {
    {
QT_MOC_LITERAL(0, 0, 13), // "RobloxWebPage"
QT_MOC_LITERAL(1, 14, 14), // "handleFinished"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14) // "QNetworkReply*"

    },
    "RobloxWebPage\0handleFinished\0\0"
    "QNetworkReply*"
};
...
void RobloxWebPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RobloxWebPage *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RobloxWebPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWebPage::staticMetaObject>(),
    qt_meta_stringdata_RobloxWebPage.data,
    qt_meta_data_RobloxWebPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RobloxWebPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RobloxWebPage.stringdata0))

...
"                  "));
    ...
    {
        TeamCreate->setWindowTitle(QCoreApplication::translate("TeamCreate", "Form", nullptr));
        publishMessageLabel->setText(QCoreApplication::translate("TeamCreate", "Publish and enable Team Create to build this place together with your friends.", nullptr));
        publishButton->setText(QCoreApplication::translate("TeamCreate", "Publish", nullptr));
        publishingMessageLabel->setText(QCoreApplication::translate("TeamCreate", "Publishing current place...", nullptr));
        loginMessageLabel->setText(QCoreApplication::translate("TeamCreate", "Log in to enable Team Create options for your place.", nullptr));
        loginButton->setText(QCoreApplication::translate("TeamCreate", "Log In", nullptr));
        friendsInviteEdit->setPlaceholderText(QCoreApplication::translate("TeamCreate", "Invite a friend", nullptr));
        userPlaceTurnOnLabel->setText(QCoreApplication::translate("TeamCreate", "Edit your place with friends, see the updates instantly.", nullptr));
        userPlaceTurnOnButton->setText(QCoreApplication::translate("TeamCreate", "Turn ON", nullptr));
        userPlaceSaveMessageLabel->setText(QCoreApplication::translate("TeamCreate", "Saving latest updates and enabling Team Create...", nullptr));
        groupPlaceTurnOnMessageLabel->setText(QCoreApplication::translate("TeamCreate", "Enable Team Create: edit your place together, see updates instantly.", nullptr));
        groupPlaceTurnOnButton->setText(QCoreApplication::translate("TeamCreate", "Turn ON", nullptr));
        groupPlaceNonAdminMessage->setText(QCoreApplication::translate("TeamCreate", "Members of your group can work together, see updates instantly. Contact your admin to enable Team Create.", nullptr));
        groupPlaceSaveMessageLabel->setText(QCoreApplication::translate("TeamCreate", "Saving latest updates and enabling Team Create...", nullptr));
        bottomMoreButton->setText(QString());
        userRemoveLabel->setText(QCoreApplication::translate("TeamCreate", "Are you sure to remove?", nullptr));
        userRemoveButton->setText(QCoreApplication::translate("TeamCreate", "Remove", nullptr));
        userRemoveCancelButton->setText(QCoreApplication::translate("TeamCreate", "Cancel", nullptr));
    } // retranslateUi

...
AuthoringSettings::AuthoringSettings()
	...
	,defaultScriptFileDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/ROBLOX/Scripts")
	...
	,recentSavesDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/ROBLOX/RecentSaves")
    ...
    , autoSaveDir(QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/ROBLOX/AutoSaves")
    // Advanced

...
public:
    ...
    void setupUi(QDialog *PairRbxDevDialog)
    {
        ...
        PairRbxDevDialog->setWindowOpacity(3.000000000000000);
    ...
    {
        PairRbxDevDialog->setWindowTitle(QCoreApplication::translate("PairRbxDevDialog", "Pair Roblox Developer Device", nullptr));
        label->setText(QCoreApplication::translate("PairRbxDevDialog", "Enter this code on your device's pair screen", nullptr));
        statusLabel->setText(QCoreApplication::translate("PairRbxDevDialog", "Waiting for device to pair....", nullptr));
        codeLabel->setText(QCoreApplication::translate("PairRbxDevDialog", "8974", nullptr));
        cancelButton->setText(QCoreApplication::translate("PairRbxDevDialog", "Done", nullptr));
    } // retranslateUi

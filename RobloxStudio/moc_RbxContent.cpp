...
struct qt_meta_stringdata_RbxContent_t {
    QByteArrayData data[4];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RbxContent_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RbxContent_t qt_meta_stringdata_RbxContent = {
    {
QT_MOC_LITERAL(0, 0, 10), // "RbxContent"
QT_MOC_LITERAL(1, 11, 6), // "Upload"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 3) // "url"

    },
    "RbxContent\0Upload\0\0url"
};
...
void RbxContent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RbxContent *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject RbxContent::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_RbxContent.data,
    qt_meta_data_RbxContent,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RbxContent::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RbxContent.stringdata0))

...
struct qt_meta_stringdata_KeepSavedChangesDialog_t {
    QByteArrayData data[8];
    char stringdata0[84];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_KeepSavedChangesDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_KeepSavedChangesDialog_t qt_meta_stringdata_KeepSavedChangesDialog = {
    {
QT_MOC_LITERAL(0, 0, 22), // "KeepSavedChangesDialog"
...
QT_MOC_LITERAL(6, 65, 9), // "onDiscard"
QT_MOC_LITERAL(7, 75, 8) // "onCancel"

    },
    "KeepSavedChangesDialog\0onClicked\0\0"
    "QAbstractButton*\0button\0onSave\0onDiscard\0"
    "onCancel"
};
...
void KeepSavedChangesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KeepSavedChangesDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject KeepSavedChangesDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QMessageBox::staticMetaObject>(),
    qt_meta_stringdata_KeepSavedChangesDialog.data,
    qt_meta_data_KeepSavedChangesDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *KeepSavedChangesDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_KeepSavedChangesDialog.stringdata0))

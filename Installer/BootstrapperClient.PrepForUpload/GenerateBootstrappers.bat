...
call:generateFlavorFunc Gametest setup-gametest.finobe.net gametest.finobe.net %1
...
call:generateFlavorFunc Sitetest setup-sitetest.finobe.net sitetest.finobe.net %1

...
#define FIREFOXREGKEY               "@nsroblox.finobe.net/launcher"
#define FIREFOXREGKEY64             "@nsroblox.finobe.net/launcher64"

#define PLAYERLINKNAME_CUR          "Finobe Player"
#define PLAYERLINKNAMELEGACY        "Play Finobe"

// MFC Studio names
#define STUDIOEXENAME               "RobloxStudio.exe"
#define STUDIOBOOTSTAPPERNAME       "RobloxStudioLauncher.exe"
#define STUDIOLINKNAMELEGACY        "Finobe Studio"    // wrong case

// QT Studio names
#define STUDIOQTEXENAME             "RobloxStudioBeta.exe"
#define STUDIOBOOTSTAPPERNAMEBETA   "RobloxStudioLauncherBeta.exe"
#define STUDIOQTLINKNAME_CUR        "Finobe Studio"
#define STUDIOQTLINKNAME            "Finobe Studio Beta"
#define STUDIOQTLINKNAME20          "Finobe Studio 2.0"
#define STUDIOQTLINKNAME20BETA      "Finobe Studio 2.0 Beta"
#define STUDIOQTLINKNAME2013        "Finobe Studio 2013"

// Player names
#define  PLAYEREXENAME				"FinobePlayer.exe"

// Version URL string names (setup.finobe.net/XXX) - replace XXX with these values to get the most recent version

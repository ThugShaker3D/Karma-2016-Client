...
static const char* kSavedScreenSizeRegistryKey =
	"HKEY_CURRENT_USER\\Software\\Finobe_Penelope\\Finobe\\Settings\\FinobePlayerV4WindowSizeAndPosition";
...
void View::initializeView()
{
	...
	if(!success)
	{
		...
		throw initialization_error(
			"Your graphics drivers seem to be too old for Finobe to use.\n\n"

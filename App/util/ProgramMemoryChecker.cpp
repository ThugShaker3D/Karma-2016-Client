...
#ifdef _DEBUG
        scanningRegions[kMsvcHash] = ScanRegionTest(ScanRegion::getScanRegion("MSVCP140D", ".text"));
#else
        scanningRegions[kMsvcHash] = ScanRegionTest(ScanRegion::getScanRegion("MSVCP140", ".text"));
#endif
